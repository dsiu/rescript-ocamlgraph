...
import * as ChaoticIteration$RescriptOcamlgraph from "../ChaoticIteration.bs.js";
...
function print_num(x) {
  if (typeof x === "number") {
    ...
    return Pervasives.print_int(x._0);
  }
}
...
function abstr_expr(interval, x) {
  if (typeof x === "number") {
    return interval;
  }
  if (x.TAG === /* Int */0) {
    return singleton(x._0);
  }
  var match = abstr_expr(interval, x._0);
  var match$1 = abstr_expr(interval, x._1);
  if (match && match$1) {
    return /* Bounded */{
