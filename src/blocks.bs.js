...
function Unlabeled(V, HM) {
  ...
  var map_vertex = function (f, g) {
    ...
    var f$1 = Curry._2(MV.memo, undefined, f);
    return Curry._2(HM.map, (function (v, s) {
                  return [
                          Curry._1(f$1, v),
                          Curry._3(S.fold, (function (v, s) {
                                  return Curry._2(S.add, Curry._1(f$1, v), s);
                                }), s, S.empty)
                        ];
                }), g);
  };
...
function BidirectionalUnlabeled(V, HM) {
  ...
  var map_vertex = function (f, g) {
    ...
    var f$1 = Curry._2(MV.memo, undefined, f);
    return Curry._2(HM.map, (function (v, param) {
                  return [
                          Curry._1(f$1, v),
                          [
                            Curry._3(S.fold, (function (v, s) {
...
function Make(F) {
  var Concrete = function (V) {
    ...
    var map_vertex = function (f, g) {
      ...
      var f$1 = Curry._2(MV.memo, undefined, f);
      return Curry._2(HM$1.map, (function (v, s) {
                    return [
                            Curry._1(f$1, v),
                            Curry._3(S.fold, (function (v, s) {
                                    return Curry._2(S.add, Curry._1(f$1, v), s);
  ...
  var ConcreteBidirectional = function (V) {
    ...
    var map_vertex = function (f, g) {
      ...
      var f$1 = Curry._2(MV.memo, undefined, f);
      return Curry._2(HM$1.map, (function (v, param) {
                    return [
                            Curry._1(f$1, v),
                            [
                              Curry._3(S.fold, (function (v, s) {
  ...
  var Abstract = function (V) {
    ...
    var G_unsafe_add_vertex = unsafe_add_vertex;
    ...
    var G = {
      ...
      unsafe_add_vertex: G_unsafe_add_vertex,
      unsafe_add_edge: unsafe_add_edge$1,
