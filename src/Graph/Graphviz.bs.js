...
function fprint_square_not_empty(printer, ppf, x) {
  if (x) {
...
function fprint_arrow_style(ppf, x) {
  if (x === "Normal") {
...
function fprint_orientation(ppf, x) {
  if (x === "Landscape") {
    return Format.fprintf(ppf, /* Format */{
                _0: {
                  TAG: /* String_literal */11,
...
function fprint_string_list(ppf, x) {
  if (!x) {
    return ;
  }
  var tl = x.tl;
...
function fprint_vertex(ppf, x) {
  ...
  if (variant === "HtmlLabel") {
    ...
    return Curry._2(Format.fprintf(ppf, /* Format */{
                    ...
                    _1: "color=%a"
                  }), fprint_color_with_transparency, x.VAL);
...
function fprint_arrow_direction(ppf, x) {
  if (x === "Both") {
    return Format.fprintf(ppf, /* Format */{
                _0: {
                  TAG: /* String_literal */11,
...
function fprint_attributes(fprint_style_list, fprint_attribute, sep, ppf, list) {
  ...
  var styles = match[1];
  var fprint_attributes_rec = function (ppf, _x) {
    while(true) {
      var x = _x;
      if (!x) {
        return ;
      ...
      Curry._4(Format.fprintf(ppf, /* Format */{
                ...
                _1: "%a%a@ "
              }), fprint_attribute, x.hd, fprint_symbseq, sep);
      _x = x.tl;
      continue ;
    };
  };
...
function fprint_string_list$1(ppf, x) {
  if (!x) {
    return ;
  }
  var tl = x.tl;
...
function fprint_graph$1(ppf, x) {
  if (typeof x !== "object") {
    return fprint_graph(ppf, x);
  }
  var variant = x.NAME;
...
function fprint_vertex$1(ppf, x) {
  var variant = x.NAME;
  if (variant === "Comment") {
    return Curry._2(Format.fprintf(ppf, /* Format */{
                    _0: {
    ...
    return fprint_vertex(ppf, x);
  }
}

function fprint_port(ppf, x) {
  if (x === "N") {
    return Format.fprintf(ppf, /* Format */{
                _0: {
                  TAG: /* Char_literal */12,
...
function Dot(param) {
  ...
  var fprint_graph_attributes = function (ppf, list) {
    return List.iter((function (x) {
                  return Curry._2(Format.fprintf(ppf, /* Format */{
                                  ...
                                  _1: "%a;@ "
                                }), partial_arg_Attributes.fprint_graph, x);
                }), list);
  };
  var fprint_graph = function (ppf, graph) {
    ...
    var print_nodes = function (ppf) {
      ...
      return Curry._2(param.iter_vertex, (function (x) {
                    var sg = Curry._1(param.get_subgraph, x);
                    if (sg !== undefined) {
                    ...
                    return Curry._3(Format.fprintf(ppf, /* Format */{
                                    ...
                                    _1: "%s%a;@ "
                                  }), Curry._1(param.vertex_name, x), (function (param, param$1) {
                                  return fprint_square_not_empty(partial_arg, param, param$1);
                                }), Curry._1(param.vertex_attributes, x));
                  }), graph);
    };
    var print_nested_subgraphs = function (ppf, _x) {
      while(true) {
        var x = _x;
        if (!x) {
          return ;
    ...
    var print_edges = function (ppf) {
      ...
      return Curry._2(param.iter_edges_e, (function (x) {
                    var partial_arg = Curry._1(partial_arg_Attributes.fprint_edge_list, /* COMMA */0);
                    return Curry._5(Format.fprintf(ppf, /* Format */{
                                    ...
                                    _1: "%s %s %s%a;@ "
                                  }), Curry._1(param.vertex_name, Curry._1(param.E.src, x)), "->", Curry._1(param.vertex_name, Curry._1(param.E.dst, x)), (function (param, param$1) {
                                  return fprint_square_not_empty(partial_arg, param, param$1);
                                }), Curry._1(param.edge_attributes, x));
                  }), graph);
    };
...
function fprint_vertex$2(ppf, x) {
  if (x.NAME !== "Pos") {
    return fprint_vertex(ppf, x);
  }
  var match = x.VAL;
  ...
  var fprint_graph_attributes = function (ppf, list) {
    return List.iter((function (x) {
                  return Curry._2(Format.fprintf(ppf, /* Format */{
                                  ...
                                  _1: "%a;@ "
                                }), partial_arg_Attributes$1.fprint_graph, x);
                }), list);
  };
  var fprint_graph = function (ppf, graph) {
    var SG = $$Map.Make({
