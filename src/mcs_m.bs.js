...
function MaximalCardinalitySearch_P(funarg) {
  ...
  var G = Persistent$Graph.Graph.Concrete(NewV);
  ...
  var check_path = function (g, u, v) {
    ...
    var aux = function (x) {
      if (Curry._2(H.mem, h, x)) {
        return false;
      } else if (Curry._2(G.V.equal, x, v)) {
        return true;
      } else if (Curry._1(data, x) < maxw || Curry._2(G.V.equal, x, u)) {
  ...
  var partial_arg$3 = Gmap$Graph.Vertex;
  var include$1 = Builder$Graph.P(G);
  ...
  var mcsm = function (g) {
    ...
    var match = fold((function (x) {
            ...
            var s = Curry._3(G.fold_vertex, (function (x, s) {
                    if (Curry._2(G.V.equal, x, v) || !check_path(g$p, x, v)) {
                      return s;
                    } else {
...
function MaximalCardinalitySearch_I(funarg) {
  ...
  var G = Imperative$Graph.Graph.Concrete(NewV);
  var EdgeSet = $$Set.Make(G.E);
  var VerticesSet = $$Set.Make(NewV);
  var Choose = Oper$Graph.Choose({
        iter_vertex: G.iter_vertex,
  ...
  var partial_arg$3 = Gmap$Graph.Vertex;
  var include$1 = Builder$Graph.I(G);
  var Copy = (function (param) {
        return partial_arg$3(partial_arg$2, param);
      })({
        empty: include$1.empty,
