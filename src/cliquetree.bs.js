...
import * as Persistent$Graph from "./persistent.bs.js";
...
function CliqueTree(funarg) {
  ...
  var CliqueTreeV = (function (param) {
  ...
  var partial_arg$2 = Persistent$Graph.Digraph.ConcreteLabeled;
  var CliqueTree$1 = partial_arg$2(CliqueTreeV, CliqueTreeE);
  var G = Persistent$Graph.Graph.Concrete(CliqueV);
  var $$let = funarg.V;
  var partial_arg_V = {
    hash: $$let.hash,
    equal: $$let.equal
  ...
  var partial_arg$4 = Gmap$Graph.Vertex;
  var include = Builder$Graph.P(G);
  ...
  var NotClique = /* @__PURE__ */Caml_exceptions.create("Cliquetree-Graph.CliqueTree(Gr).NotClique");
