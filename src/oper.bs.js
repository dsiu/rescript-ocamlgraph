...
function Make(funarg) {
  ...
  var replace_by_transitive_reduction = function (reflexiveOpt, g0) {
    ...
    var D = Traverse$Graph.Dfs({
          ...
          fold_succ: $$let$1.fold_succ
        });
    var reachable = Curry._1(H.create, Curry._1(funarg.G.nb_vertex, g0));
    ...
    var path = function (u, v) {
      return Curry._2(H.mem, Curry._2(H.find, reachable, u), v);
    };
    var phi = function (v, g) {
      var g$1 = reflexive ? Curry._3(funarg.remove_edge, g, v, v) : g;
      return Curry._4(funarg.G.fold_succ, (function (sv, g) {
                    return Curry._4(funarg.G.fold_succ, (function (sv$p, g) {
                                  if (!Curry._2(funarg.G.V.equal, sv, sv$p) && path(sv, sv$p)) {
                                    return Curry._3(funarg.remove_edge, g, v, sv$p);
                                  } else {
                                    return g;
                                  }
                                }), g, v, g);
...
function P(funarg) {
  ...
  var replace_by_transitive_reduction = function (reflexiveOpt, g0) {
    ...
    var reachable = Curry._1(H.create, Curry._1(B.G.nb_vertex, g0));
    var path_from = function (v) {
      var s = Curry._1(H.create, 8);
      Curry._3(H.add, reachable, v, s);
      return Curry._3(D.prefix_component, (function (w) {
    ...
    var phi = function (v, g) {
      ...
      return Curry._4(B.G.fold_succ, (function (sv, g) {
                    return Curry._4(B.G.fold_succ, (function (sv$p, g) {
                                  if (!Curry._2(B.G.V.equal, sv, sv$p) && path(sv, sv$p)) {
                                    return Curry._3(B.remove_edge, g, v, sv$p);
                                  } else {
                                    return g;
                                  }
                                }), g, v, g);
